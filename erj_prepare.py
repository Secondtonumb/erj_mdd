...
if __name__ == "__main__":
    ...
    save_json_train="data/train_erj_spk_open_train.json",
    save_json_test="data/test_erj_spk_open_test.json",
    metadata_l2arctic="data/metadata_erj_ver1",
    test_spks=["F07", "M07", "F01", "M06"]
)
